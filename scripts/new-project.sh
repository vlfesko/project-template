...
echo "  docker network create proxy     # shared Traefik network (once per machine; skip if it exists)"
echo "  make build"
echo "  make up                         # reachable at https://$PROJECT_NAME.docker.localhost"
